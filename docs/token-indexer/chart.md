...
You can embed a TradingView chart that uses our price feeds into your web application by using the following code:

```html
<iframe src="https://chart.intear.tech/?token=blackdragon.tkn.near" width="700px" height="400px"></iframe>
```
